      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px', flexWrap: 'wrap', gap: '12px' }}>
          <div>
            ...
            <p style={{ color: '#7c7b99', fontSize: '14px', margin: 0 }}>あなたが主催するプロジェクト</p>
          </div>
        ...
        {!myProjects || myProjects.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '80px 24px', background: 'rgba(22,22,31,0.8)', borderRadius: '20px', border: '1px dashed rgba(199,125,255,0.2)' }}>
            ...
            <p style={{ color: '#7c7b99', fontSize: '14px', margin: '0 0 24px' }}>メンバーを集めてプロジェクトを立ち上げましょう</p>
            <Link href="/projects/create" style={{
            ...
            {myProjects.map((p) => {
              ...
              return (
                <Link key={p.id} href={`/projects/${p.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                  <div style={{
                    background: 'rgba(22,22,31,0.9)', border: '1px solid rgba(199,125,255,0.15)',
                    ...
                    <div style={{ overflow: 'hidden' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px', flexWrap: 'wrap' }}>
                        ...
                        {p.category && (
                          <span style={{ padding: '2px 10px', borderRadius: '20px', fontSize: '12px', background: 'rgba(199,125,255,0.15)', color: '#c77dff' }}>
                            {p.category}
                          </span>
                        )}
                      </div>
                      <span style={{ color: '#7c7b99', fontSize: '12px' }}>
