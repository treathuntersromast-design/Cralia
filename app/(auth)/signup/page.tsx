  ...
  if (done) {
    return (
      <div style={{
        ...
        <h2 style={{ color: '#f0eff8', fontSize: '22px', fontWeight: '700', marginBottom: '12px' }}>
          確認メールを送信しました
        </h2>
        <p style={{ color: '#a9a8c0', fontSize: '15px', lineHeight: '1.6' }}>
          <strong style={{ color: '#c77dff' }}>{email}</strong> に確認メールを送信しました。
          メール内のリンクをクリックして登録を完了してください。
        </p>
        <p style={{ color: '#7c7b99', fontSize: '13px', marginTop: '16px' }}>
  ...
  return (
    <div style={{
      ...
      <p style={{ textAlign: 'center', marginTop: '20px', color: '#7c7b99', fontSize: '14px' }}>
        すでにアカウントをお持ちの方は{' '}
        <Link href="/login" style={{ color: '#c77dff', textDecoration: 'none', fontWeight: '600' }}>
          ログイン
        </Link>
      </p>
    </div>
