...
export default function RequestDraftAssistant({ creatorName, displayName, existingDraft, onApplyDraft, sidebar = false }: Props) {
    ...
    <>
      ...
      {!mode ? (
        ...
        <>
          {/* モード表示 + リセット */}
          <div style={{
            padding: '8px 16px', background: 'var(--c-input-bg-2)',
